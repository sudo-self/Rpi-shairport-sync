...
* The `libao` drivers are now listed in the help text. If available, it is suggested that the `alsa` driver should be used in preference to the `pulseaudio` driver.
